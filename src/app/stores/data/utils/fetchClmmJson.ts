...
import { type JsonClmm, type JsonClmmFile } from '../types/clmm'
...
export async function fetchClmmJsonInfo(): Promise<StoreData['clmmJsonInfos']> {
  ...
  return toCollectionObject(clmmJsonFile.data as JsonClmm[], (i) => i.id) satisfies StoreData['clmmJsonInfos']
}
