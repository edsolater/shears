import { listToJSMap, map, mapEntry, Numberish, shakeFalsy, shakeNil } from '@edsolater/fnkit'
import { jFetch } from '../../../packages/jFetch'
import { FetchRaydiumTokenPriceOptions, Token } from '../types/atoms/type'
...
async function fetchTokenPrices(tokens: Map<string, Token>, raydiumUrl: string): Promise<Map<string, Numberish>> {
