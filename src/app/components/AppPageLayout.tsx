...
import { Box, Group, KitProps, PivChild, icss_col, useKitProps } from '../../packages/pivkit'
 ...
 */
export default function AppPageLayout(kitProps: KitProps<AppPageLayoutProps>) {
      ...
      <Main
        icss={[
          icss_col,
          {
            position: 'relative',
            gridArea: 'c',
            background: 'gradient(to buttom,#0c0927, #110d36)',
            borderRadius: '20px',
          },
          {
            overflowX: 'hidden',
